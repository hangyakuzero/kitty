...
def encrypt_data(data, encoding_type):
    if encoding_type == "base64":
        ...
        raise ValueError("Invalid encoding type. Supported types: base64, url, hex, octal")
...
def main():
    ...
    parser.add_argument("encoding_type", choices=["all", "base64", "url", "hex", "octal"], help="Specify encoding type")
    ...
    if args.action == "encrypt":
        if args.encoding_type == "all":
            for encoding_type in ["base64", "url", "hex", "octal"]:
